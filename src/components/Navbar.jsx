            ...
            <div>
                <nav className="navbar">
                    ...
                    <ul className="navbar__items-menu" id="menu" status= {status}>
                        ...
                        <li className="navbar__items--link"><a className="navbar_redirections"href="https://www.linkedin.com/in/matisantillan11/">Linkedin</a></li>
                        <li className="navbar__items--link"><a className="navbar_redirections"href="https://github.com/Matisantillan11">Github</a></li>
